...
export default function CalculatorProductList({ setActiveView }) {
  ...
  const loadProducts = () => {
    try {
      setLoading(true)
      // Create single AAAC product - all specifications will be handled in one calculator
      const aaacProduct = {
        id: 'aaac',
          ...
          <div className="w-full max-w-lg">
            {products.map((product) => (
              <div
                ...
                className="bg-white border border-gray-200 rounded-xl overflow-hidden hover:border-blue-500 hover:shadow-lg transition-all duration-300 cursor-pointer group relative"
              >
                {/* Gradient Background */}
